...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int /*nShowCmd*/)
{
	...
	IDXGISwapChain1* d3d11SwapChain;
	{
		...
		//D3D11_FEATURE msaaQualityDesc{};
		//d3d11Device->CheckFeatureSupport(D3D11_FEATURE_D3D11_OPTIONS
		//    , &msaaQualityDesc, sizeof(msaaQualityDesc));
	...
	UINT offset;
	{
		float vertexData[] = { // x, y, r, g, b, a
			0.0f - 0.96f,  0.3f, 0.f, 1.f, 0.f, 1.f,
			0.5f - 0.5f, -0.3f, 1.f, 0.f, 0.f, 1.f,
			-0.5f - 0.5f, -0.3f, 0.f, 0.f, 1.f, 1.f
		};
		...
		float vertexData2[] = { // x, y, r, g, b, a
		  0.0f + 0.96f,  0.3f, 0.f, 1.f, 0.f, 1.f,
		  0.5f + 0.5f, -0.3f, 1.f, 0.f, 0.f, 1.f,
		 -0.5f + 0.5f, -0.3f, 0.f, 0.f, 1.f, 1.f
		};
		stride = 6 * sizeof(float);
		numVerts = sizeof(vertexData2) / stride;
		offset = 0;
		...
		hResult = d3d11Device->CreateBuffer(&vertexBufferDesc2, &vertexSubresourceData2, &vertexBuffer2);
		assert(SUCCEEDED(hResult));

		float vertexData3[] = { // x, y, r, g, b, a
		 0.5f,  0.5f, 0.f, 1.f, 0.f, 1.f,
		 0.0f , -0.3f, 1.f, 0.f, 0.f, 1.f,
		-0.5f , 0.5f, 0.f, 0.f, 1.f, 1.f
		};
		stride = 6 * sizeof(float);
		numVerts = sizeof(vertexData3) / stride;
		offset = 0;

		D3D11_BUFFER_DESC vertexBufferDesc3 = {};
		vertexBufferDesc3.ByteWidth = sizeof(vertexData2);
		vertexBufferDesc3.Usage = D3D11_USAGE_IMMUTABLE;
		vertexBufferDesc3.BindFlags = D3D11_BIND_VERTEX_BUFFER;

		D3D11_SUBRESOURCE_DATA vertexSubresourceData3 = { vertexData3 };

		hResult = d3d11Device->CreateBuffer(&vertexBufferDesc3, &vertexSubresourceData3, &vertexBuffer3);
		assert(SUCCEEDED(hResult));
	}
	...
	while (isRunning)
	{
		...
		FLOAT backgroundColor[4] = { 0.1f, 0.2f, 0.2f, 1.0f };
		...
		d3d11DeviceContext->IASetVertexBuffers(0, 1, &vertexBuffer2, &stride, &offset);
		...
		d3d11DeviceContext->IASetVertexBuffers(0, 1, &vertexBuffer3, &stride, &offset);
